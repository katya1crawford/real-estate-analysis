...
namespace RealEstateAnalysis.Data.Migrations
{
    ...
    [Migration("20211209030823_city-data-states")]
    partial class citydatastates
    {
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.LocationAnalysis.City", b =>
                {
                    ...
                    b.Property<DateTime?>("AutoGeneratedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<int>("MedianHouseOrCondoValueYearStart")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MedianHouseholdIncomeYearStart")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("PopulationYearStart")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.LocationAnalysis.CityDataCityUrl", b =>
                {
                    ...
                    b.ToTable("CityDataCityUrls", "LocationAnalysis");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.LocationAnalysis.CityDataStateUrl", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("CityDataStateUrls", "LocationAnalysis");
                });
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.MonetaryTransaction", b =>
                {
                    ...
                    b.ToTable("MonetaryTransactions", (string)null);
                });
