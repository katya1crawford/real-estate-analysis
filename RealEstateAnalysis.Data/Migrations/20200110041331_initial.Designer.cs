...
namespace RealEstateAnalysis.Data.Migrations
{
    ...
    [Migration("20200110041331_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.ClosingCost", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ClosingCosts","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.ExteriorRepairExpense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ExteriorRepairExpenses","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.File", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Files","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.FileContent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("FilesContent","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.GeneralRepairExpense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("GeneralRepairExpenses","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.InteriorRepairExpense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("InteriorRepairExpenses","FixAndFlipProperty");
                });

            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.Property", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Properties","FixAndFlipProperty");
                });
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.RentalProperty.Property", b =>
                {
                    ...
                    b.Property<decimal>("AnnualCapitalExpendituresRate")
                        .HasColumnType("decimal(5, 2)");

                    b.Property<decimal>("AnnualOperatingExpensesGrowthRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AnnualPotentialGrossIncomeGrowthRate")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AnnualPropertyManagementFeeRate")
                        .HasColumnType("decimal(5, 2)");

                    b.Property<decimal>("AnnualRentIncome")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.ClosingCost", b =>
                {
                    ...
                    b.HasOne("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.Property", "Property")
            ...
            modelBuilder.Entity("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.FileContent", b =>
                {
                    b.HasOne("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.File", "File")
                        .WithOne("FileContent")
                        .HasForeignKey("RealEstateAnalysis.Data.Entities.FixAndFlipProperty.FileContent", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
